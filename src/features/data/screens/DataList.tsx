  ...
  return (
    <View style={styles.container}>
     ...
     <SafeAreaView >
      ...
      <CommonButton title="Continue as a guest" textColor="#00B3B0" buttonStyle={styles.continueButton} textStyle={styles.continueButtonText} onPress={()=> navigation.navigate('Hook')} />    
